...
/*   Updated: 2023/10/19 17:52:47 by pramos           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void f_fill_p2e(char **map_full, char target, int y, int x)
// {
//     if (y < 0 || x < 0 || y >= 7 || x >= 17)
//         return;
//     if (map_full[y][x] == 'F' || map_full[y][x] == target)
//         return;
//     map_full[y][x] = 'F';
   
    
//     f_fill(map_full, target, y - 1, x);
//     f_fill(map_full, target, y + 1, x);
//     f_fill(map_full, target, y, x - 1);
//     f_fill(map_full, target, y, x + 1);
// }
