...
/*   Updated: 2023/10/17 17:12:03 by pramos           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    right(t_image *img)
{
    ...
    mlx_put_image_to_window(img->mlx, img->mlx_win, img->img, (img->x_pos - 1) * 50, img->y_pos * 50);
}
...
void    up(t_image *img)
{
    ...
    mlx_put_image_to_window(img->mlx, img->mlx_win, img->img, img->x_pos * 50, img->y_pos * 50);
    img = ft_new_sprite(img, "sprites/background.xpm");
    mlx_put_image_to_window(img->mlx, img->mlx_win, img->img, img->x_pos * 50, (img->y_pos + 1) * 50);
}
